...
public class WeatherActivity extends Activity {
    ...
    private TextView temp1Text ;//用于显示最高气温
    private TextView temp2Text ;//用于显示最低气温
    private TextView currentDateText ;//用于显示当前信息
    ...
    private void showWeather(){
        ...
        weatherDespText.setText(prefs.getString("weather_desp","无"));
